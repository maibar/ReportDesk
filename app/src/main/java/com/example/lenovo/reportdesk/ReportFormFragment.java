...
public class ReportFormFragment extends Fragment {
    ...
    public void OnInterface(Uri uri) {
        if (mListener != null) {
            mListener.OnInterface();
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnInterface) {
            mListener = (OnInterface)context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnInterface");
        }
    }
